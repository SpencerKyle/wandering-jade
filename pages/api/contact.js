...
const handler = async (req, res) => {
  if (req.method === 'POST') {
    ...
    if (!data.name || !data.email || !data.phone || !data.date || !data.address || !data.event || !data.bar || !data.package) {
