                            ...
                            <DrawerOverlay>
                                <DrawerContent>
                                    ...
                                    <DrawerBody align='center'>
                                        <Link href='/'><Text my='5' fontSize='xl'>Home</Text></Link>
                                        <Link href='/services'><Text my='5' fontSize='xl'>Services</Text></Link>
                                        <Link href='/faq'><Text my='5' fontSize='xl'>FAQ</Text></Link>
                                        <Link href='/form'><Box p={3} borderRadius={15} bg="#E6BDBE"><Text as='b' fontSize='xl' color='white'>Get a Quote</Text></Box></Link>
                                    </DrawerBody>
                                </DrawerContent>
                                </DrawerOverlay>
                        </Drawer>
